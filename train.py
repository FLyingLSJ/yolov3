...
def train():
    ...
    epochs = opt.epochs  # 500200 batches at bs 64, 117263 images = 273 epochs     COCO 数据集 epochs=(500200×64)/117263
    ...
    if opt.multi_scale: # 多尺度训练
        img_sz_min = round(img_size / 32 / 1.5)  # if img_size=416 img_sz_min=9 # 最小支持 288
        img_sz_max = round(img_size / 32 * 1.5)  # if img_size=416 img_sz_min=20
        img_size = img_sz_max * 32  # initiate with maximum multi_scale size 最大支持 640
    ...
    # Initialize distributed training 分布式训练
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            # Scale loss by nominal batch_size of 64 # https://github.com/ultralytics/yolov3/issues/507
            loss *= batch_size / 64
